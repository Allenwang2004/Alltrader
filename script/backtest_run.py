...
def run_macd_backtest(csv_path: str = "data/BTC_USDT_1m_okx_swap.csv", window_1m: int = 6000, step: int = 60, base_qty: float = 4):
    ...
    backtester.run_dynamic(window_1m=window_1m, step=step, base_qty=base_qty, leverage=20)
